...
import { FaHtml5, FaCss3Alt, FaJs, FaReact, FaNodeJs, FaUserShield, FaDatabase, FaGit } from "react-icons/fa";
import { SiNextdotjs, SiTailwindcss, SiFirebase, SiExpress, SiMongodb, SiTypescript} from "react-icons/si";
...
const skills = [
    ...
    { name: "Git", icon: <FaGit className="text-blue-600" /> }
];
                ...
                >
                    {skills.map((skill, index) => (
                        <motion.div
                            key={index}
                            custom={index}
                            className="flex flex-col items-center justify-center p-3 border-2 rounded-xl bg-white shadow-md md:h-36 md:w-36 w-28 h-28 transition-transform transform hover:scale-110 hover:shadow-xl hover:shadow-gray-500 duration-300"
